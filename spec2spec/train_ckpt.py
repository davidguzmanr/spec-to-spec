...
from everyvoice.model.feature_prediction.FastSpeech2_lightning.fs2.noam import NoamLR
...
class SpecDenoiser(LightningModule):
    def __init__(
        ...
        if self.hparams.network == 'DnCNN':
            ...
            model_ckpt = torch.load(
                '/space/partner/nrc/work/dt/eng000/Repositories/spec-to-spec/spec2spec/data/postnet.pt'
            )
    ...
    def configure_optimizers(self):
        ...
        scheduler_ckpt = torch.load(
            '/space/partner/nrc/work/dt/eng000/Repositories/spec-to-spec/spec2spec/data/scheduler.pt'
        )
